...
public class RailroadBarons implements model.RailroadBarons{
    ...
    protected RailroadMap map;

    /** The deck this game is being played with */
    protected Deck deck;

    /** The players currently in the game */
    protected List<student.Player> players;

    /** Integer representing the player whose turn it currently is */
    protected int player;

    /** List of Barons */
    protected Baron[] b = {Baron.BLUE, Baron.GREEN, Baron.RED, Baron.YELLOW};
    ...
    public RailroadBarons(){
        ...
        for (int i = 0; i < 4; i++){
            this.players.add(new student.Player(b[i], this));
        }
    }
    ...
    public void startAGameWith(RailroadMap map) {
        ...
        Card a = this.deck.drawACard();
        Card b = this.deck.drawACard();
        this.players.get(this.player).startTurn(new Pair(a, b));
    ...
    public void endTurn() {
        ...
        if (this.gameIsOver()){
            this.observers.forEach(o -> o.gameOver(this, this.getWinner()));
            return;
        }
